...
struct ServiceManagementView: View {
    ...
    private var healthStatusBar: some View {
        HStack(spacing: 12) {
            ...
            Text(viewModel.healthReport?.overallHealth.uppercased() ?? String(localized: "no_connection", comment: "Status indicating no connection"))
                .font(.appHeadline)
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack {
                ...
                Button {
                    ...
                    Label(String(localized: "restart", comment: "Button label to restart a service"), systemImage: "arrow.counterclockwise")
                        .font(.system(.caption, design: .monospaced))
                }
