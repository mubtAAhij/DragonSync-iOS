...
struct ServiceManagementView: View {
    ...
    enum ServiceAction: Identifiable {
        ...
        var title: String {
            switch self {
            case .toggle: return String(localized: "toggle_service", comment: "Action to toggle service on/off")
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack {
                ...
                Button {
                    ...
                    Label(String(localized: "restart", comment: "Button to restart a service"), systemImage: "arrow.counterclockwise")
                        .font(.system(.caption, design: .monospaced))
                }
