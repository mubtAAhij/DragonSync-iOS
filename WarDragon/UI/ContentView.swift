    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            ...
            NavigationStack {
                    ...
                    ToolbarItem(placement: .topBarTrailing) {
                        Menu {
                            Button(action: {
                                ...
                                Label(String(localized: "clear_all", comment: "Clear all button text"), systemImage: "trash")
                            }
                            ...
                            Button(action: {
                                ...
                                Label(String(localized: "stop_all_tracking", comment: "Stop all tracking button text"), systemImage: "eye.slash")
                            }
                            ...
                            Button(role: .destructive, action: {
                                ...
                                Label(String(localized: "delete_all_history", comment: "Delete all history button text"), systemImage: "trash.fill")
                            }
                        } label: {
                ...
                .alert(String(localized: "new_message_alert", comment: "New message alert title"), isPresented: $showAlert) {
                    Button(String(localized: "ok_button", comment: "OK button text"), role: .cancel) {}
                } message: {
                    if let message = latestMessage {
                        Text(String(localized: "message_details", comment: "Message details with UID, type, and location").replacingOccurrences(of: "{uid}", with: message.uid).replacingOccurrences(of: "{type}", with: message.type).replacingOccurrences(of: "{lat}", with: "\(message.lat)").replacingOccurrences(of: "{lon}", with: "\(message.lon)"))
                    }
                }
                // Add the confirmation alert
                .alert(String(localized: "delete_all_history_confirmation", comment: "Delete all history confirmation alert title"), isPresented: $showDeleteAllConfirmation) {
                    Button(String(localized: "delete_button", comment: "Delete button text"), role: .destructive) {
                    ...
                    Button(String(localized: "cancel_button", comment: "Cancel button text"), role: .cancel) {}
                } message: {
