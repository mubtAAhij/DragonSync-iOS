            ...
            NavigationStack {
                    ...
                    ToolbarItem(placement: .topBarTrailing) {
                        Menu {
                            Button(action: {
                                ...
                                Label(String(localized: "clear_all", comment: "Clear all menu item"), systemImage: "trash")
                            }
                            ...
                            Button(action: {
                                ...
                                Label(String(localized: "stop_all_tracking", comment: "Stop all tracking menu item"), systemImage: "eye.slash")
                            }
                            ...
                            Button(role: .destructive, action: {
                                ...
                                Label(String(localized: "delete_all_history", comment: "Delete all history menu item"), systemImage: "trash.fill")
                            }
                        } label: {
                ...
                .alert(String(localized: "new_message", comment: "New message alert title"), isPresented: $showAlert) {
                    ...
                    if let message = latestMessage {
                        Text(String(localized: "new_message_details", comment: "New message alert details").replacingOccurrences(of: "{uid}", with: message.uid).replacingOccurrences(of: "{type}", with: message.type).replacingOccurrences(of: "{lat}", with: message.lat).replacingOccurrences(of: "{lon}", with: message.lon))
                    }
                }
