    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            NavigationStack {
                ...
                .navigationTitle(String(localized: "dashboard_title", comment: "Dashboard navigation title"))
            }
            .tabItem {
                Label(String(localized: "dashboard_tab", comment: "Dashboard tab label"), systemImage: "gauge")
            }
            .tag(0)
            ...
            NavigationStack {
                ...
                .navigationTitle(String(localized: "detections_title", comment: "Detections navigation title"))
                .toolbar {
                    ToolbarItem(placement: .topBarTrailing) {
                        Menu {
                            Button(action: {
                                ...
                                Label(String(localized: "clear_all", comment: "Button to clear all detections"), systemImage: "trash")
                            }
                            ...
                            Button(action: {
                                ...
                                Label(String(localized: "stop_all_tracking", comment: "Button to stop all drone tracking"), systemImage: "eye.slash")
                            }
                            ...
                            Button(role: .destructive, action: {
                                ...
                                Label(String(localized: "delete_all_history", comment: "Button to delete all detection history"), systemImage: "trash.fill")
                            }
                        } label: {
                ...
                .alert(String(localized: "new_message_alert", comment: "Alert title for new detection message"), isPresented: $showAlert) {
                    Button(String(localized: "ok_button", comment: "OK button for alerts"), role: .cancel) {}
                } message: {
                    if let message = latestMessage {
                        Text(String(localized: "message_details", comment: "Alert message showing drone detection details").replacingOccurrences(of: "{uid}", with: message.uid).replacingOccurrences(of: "{type}", with: message.type).replacingOccurrences(of: "{lat}", with: "\(message.lat)").replacingOccurrences(of: "{lon}", with: "\(message.lon)"))
                    }
                }
                // Add the confirmation alert
                .alert(String(localized: "delete_all_history_confirm_title", comment: "Confirmation dialog title for deleting all history"), isPresented: $showDeleteAllConfirmation) {
                    Button(String(localized: "delete_button", comment: "Delete button for confirmation dialogs"), role: .destructive) {
                    ...
                    Button(String(localized: "cancel_button", comment: "Cancel button for dialogs"), role: .cancel) {}
                } message: {
                    Text(String(localized: "delete_history_warning", comment: "Warning message for deleting all history"))
                }
            }
            .tabItem {
                Label(String(localized: "drones_tab", comment: "Drones tab label"), systemImage: "airplane.circle")
            }
            .tag(1)
            ...
            .tabItem {
                Label(String(localized: "status_tab", comment: "Status tab label"), systemImage: "server.rack")
            }
            .tag(2)
            ...
            .tabItem {
                Label(String(localized: "settings_tab", comment: "Settings tab label"), systemImage: "gear")
            }
            .tag(3)
            NavigationStack {
            ...
            .tabItem {
                Label(String(localized: "history_tab", comment: "History tab label"), systemImage: "clock.arrow.circlepath")
            }
            .tag(4)
