    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            NavigationStack {
                ...
                .navigationTitle(String(localized: "dashboard", comment: "Navigation title for dashboard"))
            }
            .tabItem {
                Label(String(localized: "dashboard", comment: "Tab label for dashboard"), systemImage: "gauge")
            }
            .tag(0)
            ...
            NavigationStack {
                ...
                .navigationTitle(String(localized: "detections", comment: "Navigation title for detections"))
                .toolbar {
                ...
                .alert(String(localized: "new_message", comment: "Alert title for new message"), isPresented: $showAlert) {
                    ...
                    if let message = latestMessage {
                        Text(String(localized: "new_message_details", comment: "New message alert details with UID, type, and location").replacingOccurrences(of: "{uid}", with: message.uid).replacingOccurrences(of: "{type}", with: message.type).replacingOccurrences(of: "{lat}", with: "\(message.lat)").replacingOccurrences(of: "{lon}", with: "\(message.lon)"))
                    }
                }
                // Add the confirmation alert
                .alert(String(localized: "delete_all_history", comment: "Confirmation alert title for deleting all history"), isPresented: $showDeleteAllConfirmation) {
                    ...
                    Text(String(localized: "delete_all_history_warning", comment: "Warning message for deleting all history"))
                }
            }
            .tabItem {
                Label(String(localized: "drones", comment: "Tab label for drones"), systemImage: "airplane.circle")
            }
            .tag(1)
            ...
            .tabItem {
                Label(String(localized: "status", comment: "Tab label for status"), systemImage: "server.rack")
            }
            .tag(2)
            ...
            .tabItem {
                Label(String(localized: "settings", comment: "Tab label for settings"), systemImage: "gear")
            }
            .tag(3)
            NavigationStack {
            ...
            .tabItem {
                Label(String(localized: "history", comment: "Tab label for history"), systemImage: "clock.arrow.circlepath")
            }
            .tag(4)
