...
struct ContentView: View {
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            ...
            .tabItem {
                Label(String(localized: "dashboard", comment: "Dashboard tab title"), systemImage: "gauge")
            }
            .tag(0)
            ...
            NavigationStack {
                ...
                .navigationTitle(String(localized: "detections", comment: "Detections screen title"))
                .toolbar {
                    ToolbarItem(placement: .topBarTrailing) {
                        Menu {
                            ...
                            Button(action: {
                                ...
                                Label(String(localized: "stop_all_tracking", comment: "Button to stop all tracking"), systemImage: "eye.slash")
                            }
                            ...
                            Button(role: .destructive, action: {
                                ...
                                Label(String(localized: "delete_all_history", comment: "Button to delete all history"), systemImage: "trash.fill")
                            }
                        } label: {
                ...
                .alert(String(localized: "new_message", comment: "Alert title for new message"), isPresented: $showAlert) {
                    ...
                    if let message = latestMessage {
                        Text(String(localized: "message_details", comment: "Message details format").replacingOccurrences(of: "{uid}", with: message.uid).replacingOccurrences(of: "{type}", with: message.type).replacingOccurrences(of: "{lat}", with: "\(message.lat)").replacingOccurrences(of: "{lon}", with: "\(message.lon)"))
                    }
                }
                // Add the confirmation alert
                .alert(String(localized: "delete_all_history", comment: "Button to delete all history"), isPresented: $showDeleteAllConfirmation) {
                    ...
                    Text(String(localized: "delete_history_warning", comment: "Warning message about deleting history"))
                }
            }
            .tabItem {
                Label(String(localized: "drones", comment: "Drones tab title"), systemImage: "airplane.circle")
            }
            .tag(1)
            ...
            .tabItem {
                Label(String(localized: "status", comment: "Status tab title"), systemImage: "server.rack")
            }
            .tag(2)
            ...
            .tabItem {
                Label(String(localized: "settings", comment: "Settings tab title"), systemImage: "gear")
            }
            .tag(3)
            NavigationStack {
            ...
            .tabItem {
                Label(String(localized: "history", comment: "History tab title"), systemImage: "clock.arrow.circlepath")
            }
            .tag(4)
