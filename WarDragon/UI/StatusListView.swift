...
struct StatusListView: View {
    ...
    var body: some View {
                            ...
                            StatusMessageView(message: message, statusViewModel: statusViewModel)
                                .swipeActions(edge: .trailing, allowsFullSwipe: true) {
                                    Button(role: .destructive) {
                                        ...
                                        Label(String(localized: "delete", comment: "Button label to delete item"), systemImage: "trash")
                                    }
                                }
                                .contextMenu {
                                    Button(role: .destructive, action: {
                                        ...
                                        Label(String(localized: "delete", comment: "Context menu delete option"), systemImage: "trash")
                                    }
                                }
                        }
                ...
                ServiceManagementView(viewModel: serviceViewModel)
                    ...
                    .toolbar {
                        ToolbarItem(placement: .navigationBarLeading) {
                            Button(String(localized: "done", comment: "Button to close service management")) {
        ...
        .alert(String(localized: "delete_message", comment: "Alert title for delete confirmation"), isPresented: $showingDeleteConfirmation) {
            Button(String(localized: "delete", comment: "Destructive action button in alert"), role: .destructive) {
            ...
            Button(String(localized: "cancel", comment: "Cancel button in alert"), role: .cancel) {
                messageToDelete = nil
            }
        } message: {
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            if let lastReceived = statusViewModel.lastStatusMessageReceived {
                ...
                HStack {
                    Text(String(localized: "no_status_messages", comment: "Message when no status messages have been received"))
                        .font(.system(.caption, design: .monospaced))
                        .foregroundColor(.secondary)
                    Spacer()
                }
