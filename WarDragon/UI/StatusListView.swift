...
struct StatusListView: View {
    ...
    var body: some View {
                            ...
                            StatusMessageView(message: message, statusViewModel: statusViewModel)
                                ...
                                .contextMenu {
                                    Button(role: .destructive, action: {
                                        ...
                                        Label(String(localized: "delete", comment: "Delete context menu item"), systemImage: "trash")
                                    }
                                }
                        }
        ...
        .alert(String(localized: "delete_message", comment: "Alert title for delete confirmation"), isPresented: $showingDeleteConfirmation) {
            Button(String(localized: "delete", comment: "Confirm delete button"), role: .destructive) {
            ...
            Text(String(localized: "confirm_delete_message", comment: "Confirmation message for deleting status message"))
        }
    }
