    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                ...
                Text(String(localized: "system_status_header", comment: "System status card header"))
                    .font(.appHeadline)
                Spacer()
            ...
            HStack(spacing: 16) {
                CircularGauge(
                    ...
                    maxValue: 100,
                    title: String(localized: "cpu_gauge_title", comment: "CPU gauge title"),
                    unit: "%",
                    color: cpuColor
                )
                ...
                CircularGauge(
                    ...
                    maxValue: 100,
                    title: String(localized: "memory_gauge_title", comment: "Memory gauge title"),
                    unit: "%",
                    color: memoryColor
                )
                ...
                CircularGauge(
                    ...
                    maxValue: 85,
                    title: String(localized: "temperature_gauge_title", comment: "Temperature gauge title"),
                    unit: "°C",
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                Text(String(localized: "active_drones_header", comment: "Active drones card header"))
                    .font(.appHeadline)
                Spacer()
            ...
            HStack {
                StatBox(
                    title: String(localized: "tracked_stat", comment: "Tracked drones statistic label"),
                ...
                StatBox(
                    title: String(localized: "spoofed_stat", comment: "Spoofed drones statistic label"),
                    value: "\(spoofedCount)",
                ...
                StatBox(
                    title: String(localized: "nearby_stat", comment: "Nearby drones statistic label"),
                    value: "\(nearbyCount)",
                    icon: "location.fill",
                    color: .green
                )
                ...
                if randomizingCount > 0 {
                    StatBox(
                        title: String(localized: "randomizing_stat", comment: "Randomizing drones statistic label"),
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                Text(String(localized: "sdr_status_header", comment: "SDR status card header"))
                    .font(.appHeadline)
                Spacer()
                Circle()
                    .fill(sdrStatusColor)
            ...
            if let antStats = statusViewModel.statusMessages.last?.antStats {
                HStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading) {
                        Text(String(localized: "pluto_label", comment: "Pluto temperature label"))
                            .font(.appCaption)
                            .foregroundColor(.secondary)
                    ...
                    // Zynq Temperature
                    VStack(alignment: .leading) {
                        Text(String(localized: "zynq_label", comment: "Zynq temperature label"))
                            .font(.appCaption)
                            .foregroundColor(.secondary)
                    ...
                    VStack(alignment: .leading) {
                        Text(String(localized: "status_label", comment: "Status label"))
                            .font(.appCaption)
                            .foregroundColor(.secondary)
                        Text(antStats.plutoTemp != 0.0 || antStats.zynqTemp != 0.0 ? String(localized: "active_status", comment: "Active status label") : String(localized: "inactive_status", comment: "Inactive status label"))
                           .font(.system(.caption, design: .monospaced))
        ...
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                Image(systemName: "exclamationmark.triangle")
                    .foregroundColor(.red)
                Text(String(localized: "warnings_header", comment: "Warnings card header"))
                    .font(.appHeadline)
                Spacer()
            ...
            if let lastMessage = statusViewModel.statusMessages.last {
                ...
                if stats.cpuUsage > Settings.shared.cpuWarningThreshold {
                    warnings.append(SystemWarning(
                        id: "cpu",
                        title: String(localized: "high_cpu_usage_warning", comment: "High CPU usage warning message"),
                ...
                if stats.temperature > Settings.shared.tempWarningThreshold {
                    warnings.append(SystemWarning(
                        id: "temp",
                        title: String(localized: "high_temperature_warning", comment: "High temperature warning message"),
                ...
                if memoryPercent > (Settings.shared.memoryWarningThreshold * 100) {
                    warnings.append(SystemWarning(
                        id: "memory",
                        title: String(localized: "high_memory_usage_warning", comment: "High memory usage warning message"),
                ...
                if lastMessage.antStats.plutoTemp > Settings.shared.plutoTempThreshold {
                    warnings.append(SystemWarning(
                        id: "pluto_temp",
                        title: String(localized: "high_pluto_temperature_warning", comment: "High Pluto temperature warning message"),
