            ...
            if let mac = mac, let remoteId = remoteId {
                Button(action: {
                    ...
                    HStack {
                        ...
                        Text(isLoading ? String(localized: "loading", comment: "Loading indicator text") : String(localized: "faa_lookup", comment: "FAA lookup button text"))
                    }
                ...
                .alert(String(localized: "faa_lookup_error", comment: "FAA lookup error alert title"), isPresented: $showingError) {
                    ...
                    Text(faaService.error ?? String(localized: "unknown_error_occurred", comment: "Unknown error message"))
                }
            }
        }
