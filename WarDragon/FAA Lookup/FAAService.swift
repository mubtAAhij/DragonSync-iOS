                ...
                if let httpResponse = response as? HTTPURLResponse {
                    ...
                    case 502:
                        ...
                        if retryCount < maxRetries - 1 {
                            ...
                            throw NSError(domain: "FAAService",
                                          code: 502,
                                          userInfo: [NSLocalizedDescriptionKey: String(localized: "faa_service_unavailable", comment: "Error message when FAA service returns 502 proxy error")])
                        }
                    case 200:
                        // Success
                    ...
                    default:
                        ...
                        throw NSError(domain: "FAAService",
                                      ...
                                      userInfo: [NSLocalizedDescriptionKey: String(localized: "faa_http_error", comment: "Error message for FAA HTTP errors with status code").replacingOccurrences(of: "{statusCode}", with: "\(httpResponse.statusCode)")])
                    }
                }
