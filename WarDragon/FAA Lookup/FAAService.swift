                ...
                if let httpResponse = response as? HTTPURLResponse {
                    ...
                    default:
                        ...
                        throw NSError(domain: "FAAService",
                                      ...
                                      userInfo: [NSLocalizedDescriptionKey: String(localized: "faa_http_error", comment: "Error message for HTTP errors from FAA service").replacingOccurrences(of: "{status_code}", with: "\(httpResponse.statusCode)")])
                    }
                }
