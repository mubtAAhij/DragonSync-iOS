...
public struct DroneSignature: Hashable {
    ...
    public struct IdInfo: Hashable {
        ...
        public enum IdType: String, Hashable {
            ...
            case utmAssigned = String(localized: "id_type_utm_assigned", comment: "ID type: UTM assigned ID")
            case sessionId = String(localized: "id_type_session_id", comment: "ID type: specific session ID")
        ...
        public enum UAType: String, Hashable {
            ...
            case helicopter = String(localized: "ua_type_helicopter_multirotor", comment: "UA type: helicopter/multirotor")
    ...
    public struct HeightInfo: Hashable {
        ...
        public enum HeightReferenceType: String {
            ...
            case pressureAltitude = String(localized: "altitude_reference_pressure", comment: "Altitude reference: pressure altitude")
            case wgs84 = "WGS84"
        }
    ...
    public struct TransmissionInfo: Hashable {
        ...
        public enum TransmissionType: String {
            case ble = String(localized: "transmission_type_bt45_droneid", comment: "Transmission type: BT4/5 DroneID")
            case wifi = String(localized: "transmission_type_wifi_droneid", comment: "Transmission type: WiFi DroneID")
            case esp32 = String(localized: "transmission_type_esp32_droneid", comment: "Transmission type: ESP32 DroneID")
            case unknown = "Unknown"
        }
        
        public enum ProtocolType: String {
            case openDroneID = String(localized: "protocol_type_open_drone_id", comment: "Protocol type: Open Drone ID")
            case legacyRemoteID = String(localized: "protocol_type_legacy_remote_id", comment: "Protocol type: Legacy Remote ID")
            case astmF3411 = "ASTM F3411"
            case custom = String(localized: "protocol_type_custom", comment: "Protocol type: Custom")
        }
        
        public enum MessageType: String, Hashable {
            case bt45 = String(localized: "transmission_type_bt45_droneid", comment: "Transmission type: BT4/5 DroneID")
            case wifi = String(localized: "transmission_type_wifi_droneid", comment: "Transmission type: WiFi DroneID")
            case esp32 = String(localized: "transmission_type_esp32_droneid", comment: "Transmission type: ESP32 DroneID")
        }
