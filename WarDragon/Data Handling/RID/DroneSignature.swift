...
public struct DroneSignature: Hashable {
    ...
    public struct IdInfo: Hashable {
        ...
        public enum IdType: String, Hashable {
            ...
            case utmAssigned = String(localized: "id_type_utm_assigned", defaultValue: "UTM (USS) Assigned ID", comment: "ID type for UTM assigned identifier")
            case sessionId = String(localized: "id_type_session_id", defaultValue: "Specific Session ID", comment: "ID type for specific session identifier")
        ...
        public enum UAType: String, Hashable {
            ...
            case helicopter = String(localized: "ua_type_helicopter_multirotor", defaultValue: "Helicopter/Multirotor", comment: "UA type for helicopter or multirotor aircraft")
    ...
    public struct HeightInfo: Hashable {
        ...
        public enum HeightReferenceType: String {
            ...
            case pressureAltitude = String(localized: "height_reference_pressure_altitude", defaultValue: "Pressure Altitude", comment: "Height reference type for pressure altitude")
            case wgs84 = "WGS84"
        }
    ...
    public struct TransmissionInfo: Hashable {
        ...
        public enum TransmissionType: String {
            case ble = String(localized: "transmission_type_bt45_droneid", defaultValue: "BT4/5 DroneID", comment: "Transmission type for Bluetooth 4/5 DroneID")
            case wifi = String(localized: "transmission_type_wifi_droneid", defaultValue: "WiFi DroneID", comment: "Transmission type for WiFi DroneID")
            case esp32 = String(localized: "transmission_type_esp32_droneid", defaultValue: "ESP32 DroneID", comment: "Transmission type for ESP32 DroneID")
            case unknown = "Unknown"
        }
        
        public enum ProtocolType: String {
            case openDroneID = String(localized: "protocol_open_drone_id", defaultValue: "Open Drone ID", comment: "Protocol type for Open Drone ID")
            case legacyRemoteID = String(localized: "protocol_legacy_remote_id", defaultValue: "Legacy Remote ID", comment: "Protocol type for Legacy Remote ID")
            case astmF3411 = "ASTM F3411"
            case custom = String(localized: "protocol_custom", defaultValue: "Custom", comment: "Protocol type for custom protocol")
        }
