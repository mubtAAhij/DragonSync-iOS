            ...
            for (category, serviceDict) in categories {
                for (serviceName, details) in serviceDict {
                    ...
                    let serviceStatus = ServiceControl.ServiceStatus(
                        isActive: active,
                        isEnabled: enabled,
                        statusText: active ? String(localized: "service_status_running", defaultValue: "Running", comment: "Service status: running") : String(localized: "service_status_stopped", defaultValue: "Stopped", comment: "Service status: stopped"),
