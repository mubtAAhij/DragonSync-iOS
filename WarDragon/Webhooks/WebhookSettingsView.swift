...
struct WebhookSettingsView: View {
    ...
    var body: some View {
        ...
        Form {
            Section(header: Text(String(localized: "webhook_system", comment: "Header for webhook system settings section"))) {
            ...
            if settings.webhooksEnabled {
                Section(header: Text(String(localized: "event_types", comment: "Header for webhook event types section"))) {
                    Text(String(localized: "select_webhook_events", comment: "Description for webhook event selection"))
                        .font(.caption)
                        .foregroundColor(.secondary)
                    ...
                    HStack {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text(String(localized: "disable_all_status_notifications", comment: "Toggle label to disable all status notifications"))
                                .font(.headline)
                            Text(String(localized: "disable_status_notifications_description", comment: "Description for disabling all status notifications"))
                                .font(.caption)
                                .foregroundColor(.secondary)
                        }
                        Spacer()
                    ...
                    eventToggleRow(for: .droneDetected, title: String(localized: "drone_detection", comment: "Label for drone detection webhook event"), description: String(localized: "new_drone_detected", comment: "Description for drone detection webhook event"), icon: "airplane.circle.fill", color: .blue)
...
//                    
                    eventToggleRow(for: .proximityWarning, title: String(localized: "proximity_warning", comment: "Label for proximity warning webhook event"), description: String(localized: "drone_approaching_threshold", comment: "Description for proximity warning webhook event"), icon: "exclamationmark.triangle.fill", color: .orange)
                    
                    eventToggleRow(for: .systemAlert, title: String(localized: "system_alert", comment: "Label for system alert webhook event"), description: String(localized: "general_system_warnings", comment: "Description for system alert webhook event"), icon: "exclamationmark.circle.fill", color: .red)
                    
                    eventToggleRow(for: .temperatureAlert, title: String(localized: "temperature_alert", comment: "Label for temperature alert webhook event"), description: String(localized: "high_temperature_warnings", comment: "Description for temperature alert webhook event"), icon: "thermometer.high", color: .red)
                    
                    eventToggleRow(for: .memoryAlert, title: String(localized: "memory_alert", comment: "Label for memory alert webhook event"), description: String(localized: "high_memory_usage_warnings", comment: "Description for memory alert webhook event"), icon: "memorychip.fill", color: .yellow)
                    
                    eventToggleRow(for: .cpuAlert, title: String(localized: "cpu_alert", comment: "Label for CPU alert webhook event"), description: String(localized: "high_cpu_usage_warnings", comment: "Description for CPU alert webhook event"), icon: "cpu.fill", color: .red)
                }
                
                Section(header: Text(String(localized: "webhook_services", comment: "Header for webhook services section"))) {
                ...
                Section(header: Text(String(localized: "recent_deliveries", comment: "Header for recent webhook deliveries section"))) {
