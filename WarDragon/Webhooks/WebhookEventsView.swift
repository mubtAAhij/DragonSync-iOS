...
struct WebhookEventsView: View {
    ...
    var body: some View {
        NavigationView {
            Form {
                Section(header: Text(String(localized: "event_configuration", comment: "Section header for event configuration"))) {
                    Text(String(localized: "event_configuration_help", comment: "Help text for event configuration"))
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
                
                Section(header: Text(String(localized: "detection_events", comment: "Section header for detection events"))) {
                ...
                Section(header: Text(String(localized: "system_events", comment: "Section header for system events"))) {
                    ...
                    HStack {
                        Button(String(localized: "enable_all_system_events", comment: "Button to enable all system events")) {
                        ...
                        Button(String(localized: "disable_all_system_events", comment: "Button to disable all system events")) {
                            var events = settings.enabledWebhookEvents
                            let systemEvents: [WebhookEvent] = [.systemAlert, .temperatureAlert, .memoryAlert, .cpuAlert]
                            for event in systemEvents {
                                events.remove(event)
                ...
                Section(header: Text(String(localized: "connection_events", comment: "Section header for connection events"))) {
                    EventToggleRow(event: .connectionLost, settings: settings)
                    EventToggleRow(event: .connectionRestored, settings: settings)
                }
                
                Section(header: Text(String(localized: "quick_actions", comment: "Section header for quick actions"))) {
                    HStack {
                        Button(String(localized: "enable_all_events", comment: "Button to enable all events")) {
                        ...
                        Button(String(localized: "disable_all_events", comment: "Button to disable all events")) {
                ...
                Section(header: Text(String(localized: "event_summary", comment: "Section header for event summary"))) {
                    HStack {
                        Text(String(localized: "events_enabled", comment: "Label for events enabled count"))
                        Spacer()
            ...
            .navigationTitle(String(localized: "webhook_events", comment: "Navigation title for webhook events"))
...
struct EventToggleRow: View {
    ...
    private var eventDescription: String {
        switch event {
        case .droneDetected: return String(localized: "drone_detected_description", comment: "Description for drone detected event")
        case .fpvSignal: return String(localized: "fpv_signal_description", comment: "Description for FPV signal event")
        case .proximityWarning: return String(localized: "proximity_warning_description", comment: "Description for proximity warning event")
        case .systemAlert: return String(localized: "system_alert_description", comment: "Description for system alert event")
        case .temperatureAlert: return String(localized: "temperature_alert_description", comment: "Description for temperature alert event")
        case .memoryAlert: return String(localized: "memory_alert_description", comment: "Description for memory alert event")
        case .cpuAlert: return String(localized: "cpu_alert_description", comment: "Description for CPU alert event")
        case .connectionLost: return String(localized: "connection_lost_description", comment: "Description for connection lost event")
        case .connectionRestored: return String(localized: "connection_restored_description", comment: "Description for connection restored event")
        }
    }
}
