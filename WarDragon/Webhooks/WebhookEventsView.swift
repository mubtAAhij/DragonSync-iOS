        ...
        NavigationView {
            Form {
                Section(header: Text(String(localized: "event_configuration", comment: "Section header for webhook event settings"))) {
                    Text(String(localized: "event_configuration_description", comment: "Description text for webhook event configuration"))
                        .font(.caption)
                ...
                Section(header: Text(String(localized: "system_events", comment: "Section header for system-related webhook events"))) {
                    ...
                    HStack {
                        Button(String(localized: "enable_all_system_events", comment: "Button to enable all system event webhooks")) {
                        ...
                        Button(String(localized: "disable_all_system_events", comment: "Button to disable all system event webhooks")) {
                            var events = settings.enabledWebhookEvents
                            let systemEvents: [WebhookEvent] = [.systemAlert, .temperatureAlert, .memoryAlert, .cpuAlert]
                            for event in systemEvents {
                                events.remove(event)
                ...
                Section(header: Text(String(localized: "event_summary", comment: "Section header for webhook event summary"))) {
                    HStack {
                        Text(String(localized: "events_enabled_label", comment: "Label showing number of enabled events"))
                        Spacer()
            ...
            .navigationTitle(String(localized: "webhook_events_title", comment: "Navigation title for webhook events screen"))
...
struct EventToggleRow: View {
    ...
    private var eventDescription: String {
        ...
        case .systemAlert: return String(localized: "system_alert_description", comment: "Description for system alert events")
        case .temperatureAlert: return String(localized: "temperature_alert_description", comment: "Description for temperature alert events")
        case .memoryAlert: return String(localized: "memory_alert_description", comment: "Description for memory alert events")
        case .cpuAlert: return String(localized: "cpu_alert_description", comment: "Description for CPU alert events")
        case .connectionLost: return String(localized: "connection_lost_description", comment: "Description for connection lost events")
        case .connectionRestored: return String(localized: "connection_restored_description", comment: "Description for connection restored events")
        }
    }
}
