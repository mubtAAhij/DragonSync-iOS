...
struct StatusMessageView: View {
    ...
    private var statusHeader: some View {
        VStack(spacing: 8) {
            ...
            HStack {
                Text(String(localized: "last_received", comment: "Label for last received message timestamp"))
                    .font(.system(.caption, design: .monospaced))
                    .foregroundColor(.secondary)
                    ...
                    HStack(spacing: 16) {
                        ...
                        if message.antStats.plutoTemp > 0 {
                            CircularGauge(
                                ...
                                maxValue: 100,
                                title: String(localized: "pluto", comment: "Pluto device temperature label"),
                                unit: "°C",
                        ...
                        if message.antStats.zynqTemp > 0 {
                            CircularGauge(
                                ...
                                maxValue: 100,
                                title: String(localized: "zynq", comment: "Zynq device temperature label"),
                                unit: "°C",
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack {
                        Text(String(localized: "alt_label", comment: "Altitude label abbreviation"))
                            .font(.system(.caption2, design: .monospaced))
                            .foregroundColor(.secondary)
...
struct MemoryDetailView: View {
    ...
    var body: some View {
        NavigationView {
            List {
                Section(String(localized: "memory_usage", comment: "Memory usage detail label")) {
