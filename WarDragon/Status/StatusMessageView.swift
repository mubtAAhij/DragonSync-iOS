                    ...
                    HStack(spacing: 16) {
                        ...
                        if message.antStats.plutoTemp > 0 {
                            CircularGauge(
                                ...
                                maxValue: 100,
                                title: String(localized: "pluto", comment: "Pluto temperature label"),
                                unit: "°C",
                        ...
                        if message.antStats.zynqTemp > 0 {
                            CircularGauge(
                                ...
                                maxValue: 100,
                                title: String(localized: "zynq", comment: "ZYNQ temperature label"),
                                unit: "°C",
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack {
                        Text(String(localized: "alt_label", comment: "Altitude label prefix"))
                            .font(.system(.caption2, design: .monospaced))
                            .foregroundColor(.secondary)
...
struct MemoryDetailView: View {
    ...
    var body: some View {
        NavigationView {
            List {
                Section(String(localized: "memory_usage", comment: "Memory usage section title")) {
            ...
            .navigationTitle(String(localized: "memory_details_title", comment: "Memory details view title"))
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            HStack {
                ...
                Text(String(localized: "percentage_format", comment: "Percentage display format").replacingOccurrences(of: "{percentage}", with: String(format: "%.1f", percentage)))
                    .font(.system(.caption2, design: .monospaced))
                    .foregroundColor(.secondary)
            }
...
struct MapDetailView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle(String(localized: "system_location_title", comment: "System location view title"))
            .navigationBarTitleDisplayMode(.inline)
            .toolbar {
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button(String(localized: "done_button", comment: "Done button text")) {
                        dismiss()
                    }
                }
            }
