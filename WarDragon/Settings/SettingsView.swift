    ...
    var body: some View {
        Form {
            ...
            Section(String(localized: "settings_preferences", comment: "Preferences settings section")) {
                ...
                Toggle(String(localized: "enable_background_detection", comment: "Enable background detection toggle"), isOn: .init(
            ...
            Section(String(localized: "settings_notifications", comment: "Notifications settings section")) {
                Toggle(String(localized: "enable_push_notifications", comment: "Enable push notifications toggle"), isOn: .init(
            ...
            Section(String(localized: "webhooks_external_services", comment: "Webhooks and external services section")) {
                Toggle(String(localized: "enable_webhooks", comment: "Enable webhooks toggle"), isOn: .init(
                ...
                if settings.webhooksEnabled {
                    NavigationLink(destination: WebhookSettingsView()) {
                        HStack {
                            ...
                            VStack(alignment: .leading) {
                                ...
                                Text(String(localized: "services_configured_count", comment: "Number of webhook services configured").replacingOccurrences(of: "{count}", with: "\(WebhookManager.shared.configurations.count)"))
                                    .font(.caption)
                                    .foregroundColor(.secondary)
                            }
                            Spacer()
                    ...
                    Text(String(localized: "webhook_services_description", comment: "Description of webhook services"))
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
                ...
                VStack(alignment: .leading, spacing: 4) {
                    HStack {
                        ...
                        Stepper(value: $settings.messageProcessingInterval, in: 300...5000, step: 50) {
                            Text(String(localized: "milliseconds_unit", comment: "Milliseconds unit display").replacingOccurrences(of: "{value}", with: "\(settings.messageProcessingInterval)"))
                                .font(.appCaption)
                                .bold()
                ...
                VStack(alignment: .leading) {
                    ...
                    if settings.systemWarningsEnabled {
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 30) {
                                TacDial(
                                    title: String(localized: "cpu_usage_threshold", comment: "CPU usage threshold dial title"),
                                ...
                                TacDial(
                                    title: String(localized: "system_temp_threshold", comment: "System temperature threshold dial title"),
                                ...
                                TacDial(
                                    title: String(localized: "memory_threshold", comment: "Memory threshold dial title"),
                                    value: .init(
                                ...
                                TacDial(
                                    title: String(localized: "pluto_temp_threshold", comment: "Pluto temperature threshold dial title"),
                                ...
                                TacDial(
                                    title: String(localized: "zynq_temp_threshold", comment: "Zynq temperature threshold dial title"),
            ...
            Section(String(localized: "settings_ports", comment: "Ports settings section")) {
                ...
                case .multicast:
                    HStack {
                        Text(String(localized: "multicast", comment: "Connection mode option"))
                        Spacer()
