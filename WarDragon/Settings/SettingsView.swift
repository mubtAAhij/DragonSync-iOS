...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            Section(String(localized: "connection", comment: "Settings section title for connection")) {
                HStack {
                ...
                Picker(String(localized: "mode", comment: "Connection mode picker label"), selection: .init(
                ...
                if settings.connectionMode == .zmq {
                    HStack {
                        TextField(String(localized: "zmq_host", comment: "ZMQ host input field placeholder"), text: .init(
                    ...
                    HStack {
                        TextField(String(localized: "multicast_host", comment: "Multicast host input field placeholder"), text: .init(
                ...
                Toggle(isOn: .init(
                    ...
                    Text(settings.isListening && cotHandler.isListeningCot ? String(localized: "active", comment: "Connection status active") : String(localized: "inactive", comment: "Connection status inactive"))
                }
                .disabled(!settings.isHostConfigurationValid())
            }
            
            Section(String(localized: "preferences", comment: "Settings section title for preferences")) {
                Toggle(String(localized: "auto_spoof_detection", comment: "Toggle label for auto spoof detection"), isOn: .init(
                    get: { settings.spoofDetectionEnabled },
                    set: { settings.spoofDetectionEnabled = $0 }
                ))
                
                Toggle(String(localized: "keep_screen_on", comment: "Toggle label for keeping screen on"), isOn: .init(
                    get: { settings.keepScreenOn },
                    set: { settings.updatePreferences(notifications: settings.notificationsEnabled, screenOn: $0) }
                ))
                
                Toggle(String(localized: "enable_background_detection", comment: "Toggle label for background detection"), isOn: .init(
            ...
            Section(String(localized: "notifications", comment: "Settings section title for notifications")) {
                Toggle(String(localized: "enable_push_notifications", comment: "Toggle label for push notifications"), isOn: .init(
                ...
                if settings.notificationsEnabled {
                    NavigationLink(destination: StatusNotificationSettingsView()) {
                        HStack {
                            ...
                            VStack(alignment: .leading) {
                                Text(String(localized: "notification_settings", comment: "Navigation link title for notification settings"))
                                Text(String(localized: "configure_frequency_types", comment: "Subtitle for notification settings"))
                                    .font(.caption)
                    ...
                    Text(String(localized: "notifications_description", comment: "Description text for notifications"))
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
            
            Section(String(localized: "webhooks_external_services", comment: "Settings section title for webhooks")) {
                Toggle(String(localized: "enable_webhooks", comment: "Toggle label for webhooks"), isOn: .init(
                ...
                if settings.webhooksEnabled {
                    NavigationLink(destination: WebhookSettingsView()) {
                        HStack {
                            ...
                            VStack(alignment: .leading) {
                                Text(String(localized: "webhook_services", comment: "Navigation link title for webhook services"))
                                Text(String(localized: "services_configured_count", comment: "Subtitle showing number of configured services"))
                                    .font(.caption)
                                    .foregroundColor(.secondary)
                            }
                            Spacer()
                    ...
                    Text(String(localized: "webhooks_description", comment: "Description text for webhooks"))
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
            
            Section(String(localized: "performance", comment: "Settings section title for performance")) {
                VStack(alignment: .leading, spacing: 4) {
                    HStack {
                        Text(String(localized: "message_processing_interval", comment: "Label for message processing interval setting"))
                        Spacer()
                        Stepper(value: $settings.messageProcessingInterval, in: 300...5000, step: 50) {
                            Text(String(localized: "milliseconds_value", comment: "Milliseconds unit display"))
                                .font(.appCaption)
                                .bold()
            ...
            Section(String(localized: "warning_thresholds", comment: "Settings section title for warning thresholds")) {
                VStack(alignment: .leading) {
                    Toggle(String(localized: "system_warnings", comment: "Toggle label for system warnings"), isOn: $settings.systemWarningsEnabled)
                        .padding(.bottom)
                    ...
                    if settings.systemWarningsEnabled {
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 30) {
                                ...
                                TacDial(
                                    title: String(localized: "memory", comment: "Memory usage threshold dial title"),
                                    value: .init(
                ...
                VStack(alignment: .leading) {
                    Toggle(String(localized: "proximity_warnings", comment: "Toggle label for proximity warnings"), isOn: $settings.enableProximityWarnings)
                        .padding(.vertical)
            ...
            Section(String(localized: "ports", comment: "Settings section title for ports")) {
                switch settings.connectionMode {
                case .multicast:
                    HStack {
                        Text(String(localized: "multicast", comment: "Connection mode option for multicast"))
                        Spacer()
